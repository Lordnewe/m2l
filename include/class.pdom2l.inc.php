...
class PdoM2l
{
    ...
    {
        $req = "select  count(ligue.id) as nbLigue,departement.code as codeDep,
       departement.nom as nomDep from ligue right Join  departement On ligue.codeDep = departement.code
    ...
    public function getLesLiguesDepartement($code){
        $req = "select ligue.id as idLigue, ligue.nom as nomLigue, ligue.urlSiteWeb as urlLigue 
		    from  ligue where codeDep ='$code' ORDER BY nom ASC";
    ...
    public function getInfosLigue($idLigue){
        $req = "select ligue.id as idLigue, ligue.nom as nomLigue, ligue.adresseRue as adrLigue, ligue.cp as cpLigue, 
                ligue.ville as villeLigue, ligue.emailContact as emailLigue, ligue.urlSiteWeb as urlLigue, ligue.tel as numTelLigue, ligue.Olympique as OlympLigue
